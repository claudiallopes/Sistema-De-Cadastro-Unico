        ...
        <div>
                    ...
                    <div class="container text-center">
                        <div class="row">
                            ...
                            <div class="col">
                                    ...
                                    <!--<input  autocomplete="off" type="num" class="teste" name="d_parentesco" id="d_parentesco" placeholder="Digite seu parentesco">-->
                ...
                <div class="input-group mb-2">
                    <div class="container text-center">
                        <div class="row">
                            <div class="col">
                                        <button name="editar" value="adicionar"class="btn cor_botao mt-5 me-md-2" type="Submit">Salvar</button>
                            </div>
                            <div class="col"> </div>
                            <div class="col"> </div> 
                            <div Class="col">
                                        <button onclick="window.location.href = 'cadastro_visualizar.php?CPF=<?php echo $_GET['CPF'];?>'" class="btn cor_botao mt-5 me-md-2" type="button">Voltar</button>
                            </div> 
                        </div>
                    </div>
                </div>
