...
<body class="corfundo" >
  ...
  <nav class="navbar navbar-expand-lg bg-light bd-gutter flex-wrap flex-lg-nowrap shadow-sm p-3 mb-5 bg-body rounded">
    ...
    <form Action="cad_cras.php" method="POST">
        <div class="container-xxl bd-gutter  flex-lg-nowrap shadow-sm p-3 mb-5 bg-body rounded">
        <center><h1>Cadastro CRAS</h1><p><a href="consultar_geral.php" class="btn btn-light shadow-sm p-3 bg-body rounded">Visualizar CRAS ja cadastrados</a></p></center>
            <div class="mb-3">
                <label for="nome_Cras" class="form-label">Nome do CRAS</label>
                <input autocomplete="off" type="text" class="form-control" id="nome_Cras" name="nome_Cras" placeholder="Exemplo: CRAS “SILVIO BASSO”" required><br>
            </div>
            <div class="mb-3">  
                <label for="bairro_Cras" class="form-label">Bairro do CRAS</label>
                <input autocomplete="off" type="text" class="form-control" id="bairro_Cras" name="bairro_Cras" placeholder="Exemplo: São Sebastião" required><br>
            </div>
            <div class="mb-3">
                <label for="endereco_Cras" class="form-label">Endereço do CRAS(Completo)</label>
                <input autocomplete="off" id="endereco_Cras" name="endereco_Cras" class="form-control" placeholder="Exemplo: RUA CARLOS SOLDI. 495. Bairro: VILA SÃO SEBASTIÃO. CEP: 1590000 – Taquaritinga / SP" required><br>
            </div>
